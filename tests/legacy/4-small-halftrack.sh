...
./wozzle -s -i woz\ test\ images/WOZ\ 1.0/The\ Bilestoad\ -\ Disk\ 1,\ Side\ A.woz -o /tmp/out.woz
...
./wozzle -s -i woz\ test\ images/WOZ\ 2.0/The\ Bilestoad\ -\ Disk\ 1,\ Side\ A.woz -o /tmp/out.woz
SUM=`md5sum /tmp/out.woz|cut -f1 -d' '`
if [ "$SUM" != "$BTMD5" ]; then
